    ...
    <>
      ...
      <PopoverAnchor asChild>
        ...
        >
          ...
          <span className={`text-[13px] font-medium truncate max-w-[250px] transition-colors duration-300 ${isPinned || isOpen ? 'text-indigo-200' : 'text-zinc-300 group-hover:text-indigo-200'}`}>
            {directoryPath}
          </span>
          <button
            onClick={(e) => {
      ...
      <PopoverContent 
        ...
        sideOffset={12}
        className="w-[340px] bg-zinc-950/85 backdrop-blur-3xl border border-white/10 shadow-2xl rounded-2xl p-0 overflow-hidden z-[100] text-zinc-200"
      >
        {/* Header */}
