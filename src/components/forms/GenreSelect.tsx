...
export const GenreSelect: React.FC<GenreSelectProps> = ({ value, onChange, isEditing, className, usePortal = true }) => {
  const { aggregatedData, addCustomGenre } = useAudioStore();
  ...
  const confirmCreate = () => {
    addCustomGenre(pendingNewGenre);
  ...
  return (
    <div className="w-full min-w-0">
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent usePortal={usePortal} align="end" className="min-w-60 w-(--radix-popover-trigger-width) p-1 border border-white/10 bg-black/70 backdrop-blur-2xl shadow-[0_0_40px_rgba(0,0,0,0.8)] rounded-xl">
